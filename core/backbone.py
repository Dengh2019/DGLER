...
from core.dgler import DepthGuidedEventEncoder  # <--- import core module
...
class OffsetHead_RT(nn.Module):
    ...
    def forward(self, fmap1, fmap2):
        ...
        angle_range = 1/180 * torch.pi  
        rot = angle_range * torch.tanh(rot)
        return transl, rot

# ==============================================================================
# Backbone_Event (for main.py)
# ==============================================================================
class Backbone_Event(nn.Module):
    def __init__(self, args):
        ...
        # ====== Core : Utilizing deep-guided event encoder======
        self.fnet_event = DepthGuidedEventEncoder(in_channels=5, output_dim=256, norm_fn='instance', dropout=args.dropout)
    ...
    def forward(self, image1, image2, iters=12, flow_init=None, test_mode=False):
        # image1: LiDAR Depth [B, 1, H, W]
        # image2: Event Voxel [B, 5, H, W]
        image1 = 2 * image1 - 1.0
        image2 = 2 * image2 - 1.0
        ...
        # ====== Core forward propagation: Deep-guided feature extraction======
        with autocast(enabled=self.args.mixed_precision):
            fmap1 = self.fnet_lidar(image1)
            # image2 is event，image1 is depth
            fmap2 = self.fnet_event(image2, image1)
